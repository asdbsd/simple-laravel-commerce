            ...
            <div class="row g-3">
                ...
                <div class="col-sm-12">
                    ...
                    <textarea rows="4" type="text" name="description" class="form-control @error('description') is-invalid @enderror"
                         placeholder="Product description" required>{{ !$product ? old('description') : $product->description }}</textarea>
                    @error('description')
                        <div class="text-danger form-text">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4">
                            <img src="{{ asset('storage/' . $product->image )}}" alt="{{ $product->slug }}" width="100%" height="225">
                        </div>
                    </div>
