    ...
    <main class="form-signin w-100 m-auto text-center">
        <form method="POST" action="/register">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="80"
                height="72" viewBox="0 0 256 256" xml:space="preserve">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control @error('username') is-invalid @enderror" name="username"
                        aria-describedby="inputGroupPrepend2" value="{{ old('username') }}" required>
                </div>
                @error('username')
                    <div class="text-danger form-text text-left">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                <label class="form-label">Email address</label>
                <input name="email" type="email" class="form-control @error('username') is-invalid @enderror"
            ...
            <div class="mb-3">
                ...
                <input name="password" type="password" class="form-control @error('username') is-invalid @enderror"
                    required>
                @error('password')
                    <div class="text-danger form-text">{{ $message }}</div>
                @enderror
